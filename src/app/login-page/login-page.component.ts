...
export class LoginPageComponent implements OnInit {
  ...
  constructor (private router: Router) {
    this.patients.push(new Patient(1, 'Cristiano', 'Ronaldo', 'ronaldo@gmail.com', '12345', 'patient', '323 rue des bois blancs, Lille', 'M'));
    this.patients.push(new Patient(2, 'Lionel', 'Messi', 'messi@gmail.com', '123456', 'patient', '324 rue des bois blancs, Paris', 'M'));
